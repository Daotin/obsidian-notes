...
![](image_V2npyz0p_f.png)

1.  最后在“部署”-“Pages”页面，就可以看到部署成功后的页面链接。

![](image_ZQJsGuwKwo.png)
...
![](image_1IWlib6sYg.png)

![](image_dAuX782tJA.png)

**4、然后回到项目配置中，在“构建环境”配置项中选择刚才创建的 Node 版本**

![](image_pXVlT4ON5J.png)
