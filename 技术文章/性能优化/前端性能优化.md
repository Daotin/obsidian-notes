...
> Performance API、Lighthouse 和 web-vitals 库代表了不同层次的网页性能工具：

- Performance API 是底层基础，提供原始数据
- web-vitals 库是中层，简化关键指标的收集
- Lighthouse 是高层，提供综合评估和改进建议
...
performance以及过时了，有一个新的api来检测性能：[PerformanceObserver](https://developer.mozilla.org/zh-CN/docs/Web/API/PerformanceObserver/PerformanceObserver)
